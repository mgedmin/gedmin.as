...
<%def name="title()">Studies in Denmark</%def>
<%def name="short_title()">Denmark</%def>

<h2>Studies in Denmark</h2>

<p>During my University studies I spent half a year in Roskilde Business
College, Denmark, as an exchange student.  This page contains my diary of that
