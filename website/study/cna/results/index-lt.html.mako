...
<%
    ...
    data = cna_results(gr, deadlines=deadlines, holiday_week=holiday_week,
                       date_prefix_sanity_check=date_prefix_sanity_check)
%>
<h3 style="clear:both" id="gr${gr}">${title}</h3>

<div style="float: left; padding-bottom: 1em">
<table class="simple">
  <tr><th>Nr</th><th>Studentas</th><th>Užduotis</th><th colspan="2">1</th><th colspan="2">2</th><th colspan="2">3</th><th>Iš viso</th><th>Nepaisant pavėlavimų</th></tr>
...
%     endfor
  ...
  <td class="right">${row.total_no_delay}</td>
</tr>
<tr class="${['odd', 'even'][n % 2]}">
